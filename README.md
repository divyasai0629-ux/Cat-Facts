...
Plaintext
Cat-Facts/
├── index.html          # Main landing page for Cat Facts
├── currency.html       # Currency Converter interface
├── style.css           # Global custom styling
├── app.js              # Logic for fetching and displaying Cat Facts
├── currency.js         # Core logic for real-time currency conversion
└── codes.js            # Mapping for currency codes and data
